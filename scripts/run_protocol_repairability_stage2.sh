#!/bin/bash
#SBATCH --job-name=repair_stage2
#SBATCH --output=/home/kimhj/repairable-state-discovery/logs/protocol_stage2_%j.out
#SBATCH --error=/home/kimhj/repairable-state-discovery/logs/protocol_stage2_%j.err
#SBATCH --gres=gpu:1
...
PROTOCOL_PATH="${PROTOCOL_PATH:-repairable_diffusion/configs/protocol_repairability_stage2.yaml}"
...
echo "=========================================="
echo "Repairability Stage2 Protocol"
