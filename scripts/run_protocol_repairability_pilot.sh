...
#SBATCH --output=/home/kimhj/repairable-state-discovery/logs/protocol_pilot_%j.out
#SBATCH --error=/home/kimhj/repairable-state-discovery/logs/protocol_pilot_%j.err
#SBATCH --gres=gpu:1
...
PROTOCOL_PATH="${PROTOCOL_PATH:-repairable_diffusion/configs/protocol_repairability_pilot.yaml}"
...
echo "=========================================="
echo "Repairability Pilot Protocol"
