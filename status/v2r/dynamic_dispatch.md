...
Updated: `2026-09-24T08:19:03.116099+00:00`; next inventory interval: `90s`.
...
|---|---:|---|---|---:|---:|---|
| server1 | True | ['4', '7'] | ['/tmp', '/var/tmp'] | False | False | exact_native_replay_failed |
...
Running reference jobs: `9`; pending/configuring: `112`.
