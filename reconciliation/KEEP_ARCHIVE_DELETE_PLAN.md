...
|---|---|---|
| `origin/main` at `0dd161c…` | clean reproducible baseline | immutable starting point |
...
| current 12 jobs until forensic disposition | seven reference-critical; five incomplete/unknown | re-query scheduler/manifests before any action |
